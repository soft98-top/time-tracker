...
# 检查网站可访问性
echo "🌐 检查网站可访问性..."
if curl -s -o /dev/null -w "%{http_code}" https://apps.soft98.top/time-tracker | grep -q "200"; then
    echo "✅ 网站可正常访问: https://apps.soft98.top/time-tracker"
else
...
echo "   🌐 部署网站: https://apps.soft98.top/time-tracker"
